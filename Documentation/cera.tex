...
\begin{align*}
\langle \text{File} \rangle &\Coloneqq ( \langle \text{ImportDecl} \rangle \mid \langle \text{FuncDecl} \rangle \mid \langle \text{TypeDecl} \rangle \mid \langle \text{TopVarDecl} \rangle )^* \\
\langle \text{ImportDecl} \rangle &\Coloneqq [\mathbf{hidden}] \; \mathbf{import} \; \textbf{str\_lit} \textbf{;} \\
...
\begin{itemize}
    ...
    \item \textbf{FFI:} Expansion of intrinsics to allow for .so and .ddl files to be managed at runtime.
\end{itemize}
\end{document}