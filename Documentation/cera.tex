...
\begin{align*}
\langle \text{Program} \rangle &\Coloneqq ( \langle \text{FuncDecl} \rangle \mid \langle \text{TypeDecl} \rangle \mid \langle \text{TopVarDecl} \rangle )^* \\
...
\begin{itemize}
    ...
    \item \textbf{New Intrinsics \& Std Library: } \texttt{uptime}, \texttt{timeLocal}, to complete timing implementations. Standard library improved to use new hidden and inline keywords, as well as new time libary.
