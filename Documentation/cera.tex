...
\begin{lstlisting}[title={Destructuring via Variable Declarations}, basicstyle=\ttfamily]
...
\begin{lstlisting}[title={Pattern Matching with Guards}, basicstyle=\ttfamily]
...
\begin{lstlisting}[title={FFI Binding Example}, basicstyle=\ttfamily]
...
% =========================================================================
\subsection{19/06/26 - 1.0}
% =========================================================================
The inital release of the Cera functional programming language.

% =========================================================================
\subsection*{22/06/26 - 1.1 (The Ease Of Use Update)} 
% =========================================================================
...
% =========================================================================
\subsection*{22/06/26 - 1.2 (The Optimisation Update)} 
\begin{itemize}
