...
\end{enumerate}
\textit{Note:} To maintain an efficient $O(N)$ emission pass, V1 of the Cera compiler restricts pattern matching to flat, non-recursive structures. Deeply nested patterns (e.g., \texttt{Some(Ok(x))}) will trigger a compilation error.
