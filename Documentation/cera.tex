...
\begin{itemize}
    \item \textbf{\texttt{-v} (\texttt{--verbose}):} Enables verbose compiler logging.            for (int i = 0; i < varsToPop; i++)
...
\begin{itemize}
    \item \textbf{VM refactor: } Refactored virtual machine, dropping unneeded checks done by analyser, unifying memory allocation, better error messages.
    \item \textbf{Instruction Fusion: } Replaced the legacy \texttt{MATCH\_TAG} and \texttt{JUMP\_IF\_FALSE} pattern-matching pipeline with a singular \texttt{JUMP\_IF\_NOT\_TAG} superinstruction. This eliminates redundant stack manipulations and accelerates deep structural traversals.
\end{itemize}
% =========================================================================
