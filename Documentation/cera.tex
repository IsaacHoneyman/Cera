...
\begin{itemize}
    \item \textbf{VM refactor: } Refactored virtual machine memory allocation and diagnostic tools, and small bug fixes. 
...
\begin{itemize}
    ...
    \item \textbf{Concurrency:} As Cera is a functional language, a multithreaded model would fit the language perfectly, and shall come in a later version.
