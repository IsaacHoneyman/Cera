...
public partial class Analyzer
{
    ...
    private void InitializeIntrinsicFunctions()
    {
        ...
        void DefineIntrinsic(string name, ITypeAST type, int airty, List<Token>? generics = null)
        {
            generics ??= [];
            globalEnv.Define(name, new FuncSymbol(intrT[name], type, airty, generics, true));
        }
